...
SimpleTestController::SimpleTestController(wobble::term::Terminal& output_)
    : output(output_)
{
}
...
VerboseTestController::VerboseTestController(wobble::term::Terminal& output_)
    : output(output_) {}
...
struct Title
{
    ...
    Title(wobble::term::Terminal& output_, const std::string& title_)
...
void TestResultStats::print_stats(wobble::term::Terminal& out)
{
...
void TestResultStats::print_summary(wobble::term::Terminal& out)
{
