...
SimpleTestController::SimpleTestController(wobble::term::Terminal& output)
    : output(output)
{
}
...
VerboseTestController::VerboseTestController(wobble::term::Terminal& output)
    : output(output) {}
...
struct Title
{
    ...
    Title(wobble::term::Terminal& output, const std::string& title)
